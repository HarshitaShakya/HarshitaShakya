...
```python
current_work = {
    "learning": ["Advanced Python", "LLM fine-tuning", "Backend architecture"],
    "building": ["LLM-powered applications", "ML model deployment pipelines"],
    "exploring": ["Prompt engineering", "RAG systems", "API design patterns"]
}
```
...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/HarshitaShakya)
[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:shakyaharshita20@gmail.com)

---

<div align="center">
  
*Currently seeking internships and collaborative projects in AI/ML engineering*
